...
#**感想**
学习第一周，方法上还有待完善的地方。比如在用五毒神掌练习题的时候，没有将每天的习题汇总起来做一个计划，在接下来的学习中需要将这一点改善了。
在leetcode上看题解的时候有时候还是会有挫败感，本身之前没接触过数据结构和算法，需要将五毒神掌贯彻得更彻底一些。
关于课程，还是最认同超哥说的那句话，授之以鱼不如授之以渔，学习方法很重要。第一周学习效率不是很高，接下来需要改善并加油。